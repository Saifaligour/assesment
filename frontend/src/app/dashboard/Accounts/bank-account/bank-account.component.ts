...
export class BankAccountComponent implements OnInit {
  ...
  createBankAccountForm = new FormGroup({
    ...
    ac_holder_moblile: new FormControl('', [Validators.required]),
    ac_holder_email: new FormControl('', [
      Validators.required,
      Validators.email
    ]),
  ...
  ngOnInit() {
    this.bankService.getBankAccount().subscribe(
      bank => {
        if (bank) {
    ...
    if (this.createBankAccountForm.invalid) {
      ...
      this.bankService
        .createBankAccount(
          ...
          this.createBankAccountForm.value.ac_holder_moblile,
          this.createBankAccountForm.value.ac_holder_email,
